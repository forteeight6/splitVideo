from os import walk
from src.bread.add import Add_with_suffix

def test_add_with_suffix_return_none():
    """
    Verifica se a função Add return None.
    """
    contents = "OK"
    ver = Add_with_suffix("_teste", contents)

    assert ver == None
    
def test_add_with_suffix_is_right():
    """
    ...
    contents = "OK"
    Add_with_suffix("_teste", contents)
...
if __name__ == "__main__":
    test_add_with_suffix_return_none()
    test_add_with_suffix_is_right()