from os import walk
from src.bread.add import Add_with_prefix_and_sufix

def test_add_with_prefix_and_sufix_return_none():
    """
    Verifica se a função Add return None.
    """
    contents = "OK"
    ver = Add_with_prefix_and_sufix("teste_", "_teste", contents)

    assert ver == None
    
def test_add_with_prefix_and_sufix_is_right():
    """
    ...
    contents = "OK"
    Add_with_prefix_and_sufix("teste_", "_teste", contents)
...
if __name__ == "__main__":
    test_add_with_prefix_and_sufix_return_none()
    test_add_with_prefix_and_sufix_is_right()